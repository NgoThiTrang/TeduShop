...
namespace TeduShop.Web.API
{
    ...
    public class ApplicationGroupController : ApiControllerBase
    {
        ...
        public ApplicationGroupController(IErrorService errorService, IApplicationRoleService appRoleService, IApplicationGroupService appGroupService, ApplicationUserManager userManager) : base(errorService)
        {
        ...
        public HttpResponseMessage Details(HttpRequestMessage request, int id)
        {
            if (id == 0)
            {
                return request.CreateResponse(HttpStatusCode.BadRequest, nameof(id) + "is requied");
            }
            ...
            if (appGroup == null)
            {
                return request.CreateResponse(HttpStatusCode.NoContent, "not found group");
            }
